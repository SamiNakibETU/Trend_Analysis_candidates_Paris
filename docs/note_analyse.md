...
Les résultats chiffrés exhaustifs sont dans `RESULTATS_CHIFFRES.md`, généré par `scripts/export_resultats_chiffres.py`. La méthodologie est détaillée dans `methodologie.md`. Les notebooks 01 à 08 reproduisent les analyses à partir des données placées dans `../../final/data/`.
